/*Habitacion codigo Version 1.1.1 
 * Comtrol de relay por Bluetooth y por presencia
 * Lectura de temperatura en el monitor serie
 */
#define ACT 1
#define DESAC 0
#define DELAY 500
...
#define PIN_3 3
#define PIN_2 2
#define PRX_BT PIN_2  //Revisar
#define PTX_BT PIN_3
#define TRIG PIN_5   //Revisar
#define ECHO PIN_4
#define RLY_1 PIN_6  
#define RLY_2 PIN_7
#define RLY_3 PIN_8  
